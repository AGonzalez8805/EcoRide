...
<section class="text-stone-950 body-font flex-grow">
    <div class="container gap-8 px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <form action="/php/connexionPost.php" method="post" class="lg:w-2/6 md:w-1/2 bg-stone-400 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="pseudo" name="pseudo" class="w-full bg-stone-300 focus:bg-stone-200 rounded border outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative mb-4">
