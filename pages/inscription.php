...
<section class="text-stone-950 body-font">
    <div class="container gap-8 px-5 py-24 mx-auto flex flex-wrap items-center">
        <form action="/php/inscriptionPost.php" method="post" id="formulaireInscription" class="lg:w-2/6 md:w-1/2 bg-stone-400 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
